...
import { IconArrowLeft, IconArrowRight, IconBrandTelegram } from "@tabler/icons-react";
              ...
              {contact.map((testimonial, index) => (
                testimonial.src ? (
                  ...
                  <motion.div
                    ...
                    className="absolute inset-0 origin-bottom flex items-center justify-center bg-neutral-700 rounded-3xl"
                  >
          ...
          >
            ...
            {contact[active].telegram && (
                ...
                <a
                  ...
                  className="hover:text-white flex gap-3 w-fit"
                >
